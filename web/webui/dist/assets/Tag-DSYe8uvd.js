...
`,[u("strong",`
 ...
 `,[z("disabled",[I("&:hover","background-color: var(--n-color-checked-hover);"),I("&:active","background-color: var(--n-color-checked-pressed);")])])])]),So=Object.assign(Object.assign(Object.assign({},K.props),zo),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,triggerClickOnClose:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalCloseIsButtonTag:{type:Boolean,default:!0},onCheckedChange:Function}),Bo=xo("n-tag"),Ro=ho({name:"Tag",props:So,slots:Object,setup(l){const t=uo(null),{mergedBorderedRef:e,mergedClsPrefixRef:f,inlineThemeDisabled:a,mergedRtlRef:d,mergedComponentPropsRef:n}=bo(l),s=S(()=>{var o,c;return l.size||((c=(o=n?.value)===null||o===void 0?void 0:o.Tag)===null||c===void 0?void 0:c.size)||"medium"}),i=K("Tag","-tag",Io,Po,l,f);ko(Bo,{roundRef:mo(l,"round")});function p(){if(!l.disabled&&l.checkable){const{checked:o,onCheckedChange:c,onUpdateChecked:C,"onUpdate:checked":g}=l;C&&C(!o),g&&g(!o),c&&c(!o)}}function k(o){if(l.triggerClickOnClose||o.stopPropagation(),!l.disabled){const{onClose:c}=l;c&&fo(c,o)}}const b={setTextContent(o){const{value:c}=t;c&&(c.textContent=o)}},B=Co("Tag",d,f),y=S(()=>{const{type:o,color:{color:c,textColor:C}={}}=l,g=s.value,{common:{cubicBezierEaseInOut:H},self:{padding:$,closeMargin:R,borderRadius:M,opacityDisabled:T,textColorCheckable:E,textColorHoverCheckable:_,textColorPressedCheckable:W,textColorChecked:j,colorCheckable:O,colorHoverCheckable:w,colorPressedCheckable:L,colorChecked:V,colorCheckedHover:q,colorCheckedPressed:A,closeBorderRadius:G,fontWeightStrong:J,[h("colorBordered",o)]:Q,[h("closeSize",g)]:X,[h("closeIconSize",g)]:Y,[h("fontSize",g)]:Z,[h("height",g)]:F,[h("color",o)]:oo,[h("textColor",o)]:eo,[h("border",o)]:ro,[h("closeIconColor",o)]:N,[h("closeIconColorHover",o)]:lo,[h("closeIconColorPressed",o)]:co,[h("closeColorHover",o)]:ao,[h("closeColorPressed",o)]:no}}=i.value,P=po(R);return{"--n-font-weight-strong":J,"--n-avatar-size-override":`calc(${F} - 8px)`,"--n-bezier":H,"--n-border-radius":M,"--n-border":ro,"--n-close-icon-size":Y,"--n-close-color-pressed":no,"--n-close-color-hover":ao,"--n-close-border-radius":G,"--n-close-icon-color":N,"--n-close-icon-color-hover":lo,"--n-close-icon-color-pressed":co,"--n-close-icon-color-disabled":N,"--n-close-margin-top":P.top,"--n-close-margin-right":P.right,"--n-close-margin-bottom":P.bottom,"--n-close-margin-left":P.left,"--n-close-size":X,"--n-color":c||(e.value?Q:oo),"--n-color-checkable":O,"--n-color-checked":V,"--n-color-checked-hover":q,"--n-color-checked-pressed":A,"--n-color-hover-checkable":w,"--n-color-pressed-checkable":L,"--n-font-size":Z,"--n-height":F,"--n-opacity-disabled":T,"--n-padding":$,"--n-text-color":C||eo,"--n-text-color-checkable":E,"--n-text-color-checked":j,"--n-text-color-hover-checkable":_,"--n-text-color-pressed-checkable":W}}),v=a?vo("tag",S(()=>{let o="";const{type:c,color:{color:C,textColor:g}={}}=l;return o+=c[0],o+=s.value[0],C&&(o+=`a${U(C)}`),g&&(o+=`b${U(g)}`),e.value&&(o+="c"),o}),y,l):void 0;return Object.assign(Object.assign({},b),{rtlEnabled:B,mergedClsPrefix:f,contentRef:t,mergedBordered:e,handleClick:p,handleCloseClick:k,cssVars:a?void 0:y,themeClass:v?.themeClass,onRender:v?.onRender})},render(){var l,t;const{mergedClsPrefix:e,rtlEnabled:f,closable:a,color:{borderColor:d}={},round:n,onRender:s,$slots:i}=this;s?.();const p=D(i.avatar,b=>b&&x("div",{class:`${e}-tag__avatar`},b)),k=D(i.icon,b=>b&&x("div",{class:`${e}-tag__icon`},b));return x("div",{class:[`${e}-tag`,this.themeClass,{[`${e}-tag--rtl`]:f,[`${e}-tag--strong`]:this.strong,[`${e}-tag--disabled`]:this.disabled,[`${e}-tag--checkable`]:this.checkable,[`${e}-tag--checked`]:this.checkable&&this.checked,[`${e}-tag--round`]:n,[`${e}-tag--avatar`]:p,[`${e}-tag--icon`]:k,[`${e}-tag--closable`]:a}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},k||p,x("span",{class:`${e}-tag__content`,ref:"contentRef"},(t=(l=this.$slots).default)===null||t===void 0?void 0:t.call(l)),!this.checkable&&a?x(go,{clsPrefix:e,class:`${e}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:n,isButtonTag:this.internalCloseIsButtonTag,absolute:!0}):null,!this.checkable&&this.mergedBordered?x("div",{class:`${e}-tag__border`,style:{borderColor:d}}):null)}});export{Ro as N,$o as u};
